...
/**
 * This is a frame class which could generate a process frame for SHA algorithm.
 * @author aaafc
 *
 */
public class MySHADisplay extends JFrame implements MyProcessDisplay{
	
	private static MySHADisplay theInstance = null;
	public static MySHADisplay getInstance()
	{
		if(theInstance == null)
			theInstance = new MySHADisplay();
		return theInstance;
	}

	public MySHAProcessor processor = null;
...
//		getContentPane().add(keyPairSelectBox);
		...
		messageSelectBox.setBounds(573, 431, 228, 43);
...
//		getContentPane().add(keyPair);
		...
		messageSelect.setBounds(447, 430, 100, 43);
		...
		JButton encryptButton = new JButton("Hashing");
		encryptButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (currentMessage != null) {
					try {
						processor.EncryptMessage(currentMessage, 0);
