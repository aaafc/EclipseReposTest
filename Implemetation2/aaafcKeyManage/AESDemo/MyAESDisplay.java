 ...
 *
 */
public class MyAESDisplay extends JFrame implements MyProcessDisplay{
	private static MyAESDisplay theInstance = null;
	public static MyAESDisplay getInstance()
	{
		if(theInstance == null)
			theInstance = new MyAESDisplay();
		return theInstance;
	}

	public MyAESProcessor processor = null;
