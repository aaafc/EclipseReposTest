 ...
 *
 */
public class MyDESAssessDisplay extends JFrame implements MyProcessAssessDisplay{
	
	private static MyDESAssessDisplay theInstance = null;
	public static MyDESAssessDisplay getInstance()
	{
		if(theInstance == null)
			theInstance = new MyDESAssessDisplay();
		return theInstance;
	}
	...
	private MyDESAssessment assessment;
	
	private MyDESAssessDisplay() {
		assessment = new MyDESAssessment();
		...
		doProcess.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e)
			{
				try {
					...
					long[] temp = MyDESAssessDisplay.this.assessment.
				...
				}catch(NumberFormatException numForExp)
				{
					...
					JOptionPane.showMessageDialog(MyDESAssessDisplay.this, "Invalid value format.");
				} catch (Exception e1) {
					// TODO Auto-generated catch block
					e1.printStackTrace();
					JOptionPane.showMessageDialog(MyDESAssessDisplay.this, "Exception: " 
